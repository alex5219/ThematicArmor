...
public class EntityStim extends Entity implements IProjectile {
    ...
    static {
        ...
        CRITICAL = EntityDataManager.createKey(EntityStim.class, DataSerializers.BYTE);
    }
    ...
    public EntityStim(World world, double x, double y, double z) {
        this(world);
        this.setPosition(x, y, z);
    }

    public EntityStim(World world, EntityLivingBase entityLivingBase) {
        this(world, entityLivingBase.posX, entityLivingBase.posY + (double) entityLivingBase.getEyeHeight() - 0.10000000149011612D, entityLivingBase.posZ);
        this.shootingEntity = entityLivingBase;
    }

    public static void registerFixesArrow(DataFixer dataFixer, String fixes) {
    }

    public static void registerFixesArrow(DataFixer dataFixer) {
        registerFixesArrow(dataFixer, "Arrow");
    }

    @SideOnly(Side.CLIENT)
    public boolean isInRangeToRenderDist(double inRange) {
    ...
    public void shoot(Entity entity, float p_shoot_2_, float p_shoot_3_, float p_shoot_4_, float p_shoot_5_, float p_shoot_6_) {
