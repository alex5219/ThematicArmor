...
public class ItemOperatorArmor extends ItemArmor {
    ...
    public ItemOperatorArmor(EntityEquipmentSlot compatibleEntityEquipmentSlot, Operator operator) {
        super(ArmorMaterial.DIAMOND, 0, compatibleEntityEquipmentSlot);
    ...
    public String getItemStackDisplayName(ItemStack itemstack) {
        ...
        return I18n.format(SiegeHelper.getHeroFromArmor(itemstack).getUnlocalizedName().replace('_', '.')) + "'s " + I18n.format(part);
    }
        ...
        if (itemStack != null) {
            if (itemStack.getItem() instanceof ItemOperatorArmor) {
                for (SiegeRenderer siegeRenderer : SiegeRendererManager.siegeRenderers) {
                    if (siegeRenderer.getOperator().equals(SiegeHelper.getHeroFromArmor(itemStack))) {
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            multimap.put(SharedMonsterAttributes.MAX_HEALTH.getName(), new AttributeModifier(ARMOR_MODIFIERS[equipmentSlot.getIndex()], "Armor speed", -1.25 + armor, 0));
        }
