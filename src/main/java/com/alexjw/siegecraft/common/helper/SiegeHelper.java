package com.alexjw.siegecraft.common.helper;
...
import com.alexjw.siegecraft.common.items.armor.ItemDroneArmor;
import com.alexjw.siegecraft.common.items.armor.ItemOperatorArmor;
...
public class SiegeHelper {
    public static Operator getOperator(EntityPlayer entityPlayer) {
        if (entityPlayer.getArmorInventoryList().iterator().next() != null) {
            return getHeroFromArmor(entityPlayer.getArmorInventoryList());
        } else {
            return null;
        }
    }

    public static Operator getHeroFromArmor(Iterable<ItemStack> equipmentAndArmor) {
        return getHeroFromArmor(equipmentAndArmor.iterator().next());
    }

    public static Operator getHeroFromArmor(ItemStack itemstack) {
        if (itemstack != null) {
