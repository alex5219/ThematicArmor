...
public class ModelOperatorCapitao extends ModelBiped {
    ...
    public ModelOperatorCapitao() {
        ...
        bipedHeadPatchStrap1.cubeList.add(new ModelBox(bipedHeadPatchStrap1, 12, 21, -0.8409F, -6.1591F, 0.025F, 1, 6, 1, -0.1F, false));
        bipedHeadPatchStrap1.cubeList.add(new ModelBox(bipedHeadPatchStrap1, 13, 22, -0.4697F, -6.1768F, 7.55F, 1, 6, 1, -0.175F, false));
        ...
        bipedHeadHat.cubeList.add(new ModelBox(bipedHeadHat, 76, 24, -0.3506F, -5.837F, -0.25F, 2, 9, 8, -0.05F, false));
        bipedHeadHat.cubeList.add(new ModelBox(bipedHeadHat, 76, 24, 0.7211F, -5.5183F, -0.5F, 2, 9, 9, -0.325F, false));
        ...
        bipedHeadPatchHat.cubeList.add(new ModelBox(bipedHeadPatchHat, 18, 25, 2.25F, -29.0F, -4.35F, 2, 1, 1, -0.2F, false));
        bipedHeadPatchHat.cubeList.add(new ModelBox(bipedHeadPatchHat, 18, 25, 0.45F, -29.0F, 3.35F, 4, 1, 1, -0.2F, false));
        bipedHeadPatchHat.cubeList.add(new ModelBox(bipedHeadPatchHat, 77, 12, 3.5F, -29.0F, -4.0F, 1, 1, 8, -0.2F, false));
        bipedHeadPatchHat.cubeList.add(new ModelBox(bipedHeadPatchHat, 81, 26, -4.0F, -31.75F, -4.0F, 8, 2, 8, 0.15F, false));
        ...
        bipedHeadPatchHat.cubeList.add(new ModelBox(bipedHeadPatchHat, 60, 58, -6.75F, -34.75F, -4.0F, 8, 8, 3, -3.25F, false));
        ...
        bipedBodyVest.cubeList.add(new ModelBox(bipedBodyVest, 109, 11, 0.5F, -25.0F, -3.25F, 4, 5, 3, -0.95F, false));
        ...
        bipedBodyVest.cubeList.add(new ModelBox(bipedBodyVest, 101, 11, -4.5F, -25.0F, -3.25F, 4, 5, 3, -0.95F, false));
        ...
        bipedRightArmSleeve.cubeList.add(new ModelBox(bipedRightArmSleeve, 81, 20, -8.0F, -18.75F, -2.0F, 4, 2, 4, 0.15F, false));
        ...
        bipedLeftArmSleeve.cubeList.add(new ModelBox(bipedLeftArmSleeve, 101, 24, 4.0F, -18.75F, -2.0F, 4, 2, 4, 0.15F, false));
        ...
        bipedLeftLegBag.cubeList.add(new ModelBox(bipedLeftLegBag, 80, 17, 0.0F, -9.75F, -2.0F, 4, 1, 4, 0.175F, false));
