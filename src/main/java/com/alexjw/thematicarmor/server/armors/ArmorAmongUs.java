...
import com.alexjw.thematicarmor.server.specialists.SpecialistAbsoluteDefense;
import com.alexjw.thematicarmor.server.specialists.SpecialistManager;
import net.minecraft.entity.player.EntityPlayer;

public class ArmorAmongUs extends Armor {
    public ArmorAmongUs() {
        super(SpecialistManager.specialistLightfooted,SpecialistManager.specialistAbsoluteDefense);
    }
