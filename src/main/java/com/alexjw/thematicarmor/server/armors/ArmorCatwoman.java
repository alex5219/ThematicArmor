...
public class ArmorCatwoman extends Armor {
    public ArmorCatwoman() {
        super(SpecialistManager.specialistDisarm, SpecialistManager.specialistSpider, SpecialistManager.specialistTenacity);
    }
    public void getAttributeModifiers(EntityPlayer entity, IAttributeContainer attributes) {
        ...
        attributes.add(ThematicAttributes.MAX_HEALTH, 0.0f, 0);
