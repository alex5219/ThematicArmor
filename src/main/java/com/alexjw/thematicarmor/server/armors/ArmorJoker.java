...
import com.alexjw.thematicarmor.server.specialists.*;
import net.minecraft.entity.player.EntityPlayer;

public class ArmorJoker extends Armor {
    public ArmorJoker() {
        super(SpecialistManager.specialistInfection, SpecialistManager.specialistConfuse, SpecialistManager.specialistPayback, SpecialistManager.specialistTenacity);
    }
